...
#define ALIGN_DELAY_MS          500         /* Delay (ms) for the rotor to align with stationary current vector */
...
#define D_AXIS_CONTROLLER_KI    0*(-0.0002f)     /* I-term (integral gain) */
...
#define Q_AXIS_CONTROLLER_KI    0*(-0.0002f)
